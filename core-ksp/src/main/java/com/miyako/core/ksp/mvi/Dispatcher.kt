...
inline fun <reified T, reified R> defReturn(
  tag: String,
...
object Dispatcher {
  ...
  private fun generatedDispatcher(
    ...
    val buildList =
      buildObject.declaredFields.map {
      ...
      if (className.isNotEmpty()) {
        ...
        delegateClass.kotlin.constructors.firstOrNull {
          ...
          defReturnArr.find {
            ...
            val field = delegateClass.kotlin.members
              .filterIsInstance<KMutableProperty<*>>()
              .find { it.name == "defReturn" }
            if (field != null) {
  ...
  inline fun <T, reified R> dispatch(
    obj: Any,
    arg: T
  ): R {
